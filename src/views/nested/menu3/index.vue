  ...
  <div class="app-container">
    <div class="func-list">
      <div class="left search-group">
        ...
        <el-select v-model="form.quiz" placeholder="请选择实验" class="input">
          <el-option
    ...
    <el-table-column label="序号" align="center" width="95">
      ...
      <el-table-column label="实验题目" width="260" align="center">
      ...
      <el-table-column label="操作" align="center">
        <template slot-scope="scope">
          <el-button @click="handleAdd(scope.row.id)">增加实验</el-button>
          <el-button @click="handledelete(scope.row.id)">删除实验</el-button>
        </template>
      </el-table-column>
  ...
  methods: {
    ...
    deleteEdit() {
      for(let i =0;i<this.quizdeleteId.length;i++) {
        for(let j = 0;j <this.quizlist.length;j++) {
          if(this.quizdeleteId[i] == this.quizlist[j].id) {
