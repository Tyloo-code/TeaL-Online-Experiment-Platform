        ...
        getoList(odatarout).then(({ data }) => {
          ...
          this.list.forEach((item, index) => {
            ...
            myQuizzes.forEach((item, index) => {
              var myObj = {};
              myObj = {'course':this.courses,'name':item.name,'id':item.id};
              item.myObj = myObj;
            })
          })
          console.log(this.list);
    ...
    */
    ...
    // },
      handleview(id){
        ...
        this.$router.push({
          ...
          params:{
            id,
            studentid:this.$store.getters.num,
          }
        })
      },
    handledelete(id) {
    ...
    fetchData() {
      ...
      // });}else{
        ...
        this.isSecond = true;
        let odatarout = ''
        odatarout = localStorage.getItem('_stuCourseName');
        this.listLoading = true
        getoList(odatarout).then(({ data }) => {
          this.list = data.value
          console.log(this.list);
          ...
          this.list.forEach((item, index) => {
            ...
            myQuizzes.forEach((item, index) => {
              var myObj = {};
              myObj = {'course':localStorage.getItem('_stuCourseName'),'name':item.name,'id':item.id};
              item.myObj = myObj;
            })
          })
          console.log(this.list);
