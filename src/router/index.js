    ...
    children: [
      {
        ...
        name: "Menu1",
        meta: { title: "新建实验" ,roles: ['Teacher','Maintainer']}
      },
      {
        path: "menu2",
        component: () => import("@/views/nested/menu2/index"),
        name: "Menu2",
        meta: { title: "实验班级管理" ,roles: ['Teacher','Maintainer']}
      },
      {
        path: "menu3",
    ...
    children: [
      {
        ...
        meta: { title: "实验编制", icon: "dashboard",roles: ['Teacher','Maintainer'], keepAlive: true } //此组件需要缓存
      }
    ]
  },
    ...
    children: [
      {
        ...
        meta: { title: "教师实验管理", icon: "link" , roles: ['Teacher','Maintainer']}
      },
    ]
  },
  {
    ...
    children: [
      {
        ...
        meta: { title: "学生实验情况", icon: "el-icon-s-help", roles: ['Student','Maintainer']},
        hidden:true,
      }
    ]
  },
    ...
    children: [
      {
        ...
        meta: { title: "学生实验管理", icon: "link" , roles: ['Student','Maintainer']}
      },
    ]
  },
  {
  ...
  },
  {
    ...
    children: [
      { 
        ...
        meta: { title: "答案", icon: "link" , roles: ['Student','Maintainer','Teacher']}
      }
    ],
    hidden:true
  },
  {
    ...
    children: [
      { 
        name:'stuAnswer1',
        path: "stuAnswer1/:id",
        component: () => import("@/views/stuAnswer/index1"),
        meta: { title: "答案", icon: "link" , roles: ['Student','Maintainer','Teacher']}
      }
    ],
    hidden:true
